...
Topic: WIFI
------------------
Choose a strong / complex unique wlan-name (ssid) and password (20 digits) for every active wlan  
...
Disable WLANs if you don't use them (Guest-WLANs and while on holidays, weekend-trips, sleeping, etc)
...
Shields > Content filtering -> Filter Lists -> All of it -> Save
...
------------------------------
Use a end-to-end encrypted and secure 2FA-Authenticator service like ProtonAuthenticator on any account if possible - https://proton.me
