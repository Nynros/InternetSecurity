...
Topic: WIFI
------------------
Choose a strong unique name for every WLAN you use (not Model of the Router, Your Name, Adress, etc) 
Choose a strong unique password for every WLAN you use (not Model of the Router, Your Name, Adress, etc) 
